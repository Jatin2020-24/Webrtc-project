          ...
          <p className="text-light">for more information, visit <a  className="text-success"href={"https://www.pclubuiet.com/"}>PClub</a></p>
            ...
            <div className="card-body ">
              <form>
               ...
               <button className="btn float-right btn-success">Login</button>
              </form>
            </div>
            <div className="card-footer">
              <div className="d-flex justify-content-center links">
                Don't have an account? &nbsp;<a className="text-success" href={"/signup"}>Sign Up</a>
              </div>
              <div className="d-flex justify-content-center">
                <a className="text-success" href="#">Forgot your password?</a>
              </div>
            </div>
